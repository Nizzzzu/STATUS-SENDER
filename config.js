...
global.gurl = process.env.GURL || "https://chat.whatsapp.com/GJP3LbzZ2YBEsblchTslo4";
global.website = process.env.GURL || "https://chat.whatsapp.com/GJP3LbzZ2YBEsblchTslo4";
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://i.ibb.co/8zs82r9/a.png";
global.devs = "923135673658";
global.sudo = process.env.SUDO || "94789958225,94757660788,94770730717,94785274495";
global.owner = process.env.OWNER_NUMBER || "9495779900285";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "🇱🇰 P͢O͢W͢E͢R͢ B͢Y͢ KING MALIYA",
  author: process.env.PACK_AUTHER || "𝐑𝐂𝐃",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "MALIYA PROGRAMMER",
  ownername: process.env.OWNER_NAME || "MALIYA PROGRAMMER",
